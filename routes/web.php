...
Route::get('/complaints/find/{search}', 'ComplaintsController@findByCustomerAccOrEmail')->name('complaint-find');
...
Route::get('/complaints/{complaint}', 'ComplaintsController@show')->name('complaint-show');
...
Route::get('/reports', 'ReportsController@stock')->name('reports');
